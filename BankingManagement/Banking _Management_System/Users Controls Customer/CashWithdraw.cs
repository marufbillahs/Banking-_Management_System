...
{
    public partial class CashWithdraw : UserControl
    {
        public CashWithdraw()
        {
            InitializeComponent();
        ...
        private void guna2TextBox6_TextChanged(object sender, EventArgs e)// amount enter for withdraw 
        {
            string userInput = Amount.Text;
        }

        private void guna2TextBox3_TextChanged(object sender, EventArgs e)// PIN enter for withdraw
        {
            string userInput = guna2TextBox3.Text;
        }


        private void guna2TextBox2_TextChanged(object sender, EventArgs e)// Account no enter for withdraw
        {
           
            string userInput = AccountNo.Text;
               
        }

        private void guna2TextBox1_TextChanged(object sender, EventArgs e)// nam enter for witgdraw
        {
            string userInput = guna2TextBox1.Text;
        }
