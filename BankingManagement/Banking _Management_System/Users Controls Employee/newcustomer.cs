            ...
            try
            {
                ...
                if (con.State == ConnectionState.Open)
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        ...
                        {
                            if (int.TryParse(initialamounttb.Text, out _))
                            {
                                if (tbphone.Text.Length == 11 && tbphone.Text.StartsWith("01") && long.TryParse(tbphone.Text, out _))
                                {
                                    ...
                                    accountquery.Parameters.AddWithValue("@balance", int.Parse(initialamounttb.Text));
                            ...
                            {
                                MessageBox.Show("Enter inter number");
                            }
                        }
                        else
                        {
